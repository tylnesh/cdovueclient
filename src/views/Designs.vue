...
const retrieveUrl = ref("http://localhost:8080/api/design");
const createUrl = ref("http://localhost:8080/api/design/post");
const updateUrl = ref("http://localhost:8080/api/design/update");
const deleteUrl = ref("http://localhost:8080/api/design/delete");
const searchUrl = ref("http://localhost:8080/api/design/search");
...
const sendSearchRequest = debounce(async () => {
  ...
  Object.assign(searchModel, [
    {
      manufacturer: searchInput.value,
      model: searchInput.value,
      yearFrom: parseInt(searchInput.value),
      yearTo: parseInt(searchInput.value),
    },
  ]);
  Object.assign(formBody, { design: searchInput.value });
  Object.assign(formBody, { models: searchModel });
